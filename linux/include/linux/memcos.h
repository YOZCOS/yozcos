...
/* tmm option */
#define MEMCOS_NO_MIG 0x0 /* unused */
#define MEMCOS_BASELINE 0x1 /* unused */
#define MEMCOS_HUGEPAGE_OPT 0x2 /* only used */
#define MEMCOS_HUGEPAGE_OPT_V2 0x3 /* unused */
#define MEMCOS_NO_DEMOTE 0x4 //test
...
/* memcos_core.c */
extern void memcos_mm_init(struct mm_struct *mm);
extern void memcos_mm_exit(struct mm_struct *mm);
extern void __prep_transhuge_page_for_memcos(struct mm_struct *mm,
					     struct page *page);
extern void prep_transhuge_page_for_memcos(struct vm_area_struct *vma,
					   struct page *page);
...
extern bool deferred_split_huge_page_for_memcos(struct page *page);
extern unsigned long
deferred_split_scan_for_memcos(struct mem_cgroup_per_node *pn,
...
extern void uncharge_memcos_pte(pte_t *pte, struct mem_cgroup *memcg);
extern void uncharge_memcos_page(struct page *page, struct mem_cgroup *memcg);
extern void charge_memcos_page(struct page *page, struct mem_cgroup *memcg);
...
/* memcos_migrater.c */
#define MEMCOS_MIN_FREE_PAGES 256 * 10 // 10MB
